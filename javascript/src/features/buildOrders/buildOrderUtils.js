 ...
 * @param {import("../../utils/common/globalTypes").BuildOrder} buildOrder - The build order object.
 ...
 * @returns {import("../../utils/common/globalTypes").InterpretedAction[]} An array of objects representing the interpreted actions.
 */
function interpretBuildOrderAction(action, comment = '') {
  ...
  /** @type {import("../../utils/common/globalTypes").InterpretedAction[]} */
 ...
 * @returns {import('../../utils/common/globalTypes').RaceBuildOrders} Build orders loaded from the directory.
 */
function loadBuildOrdersFromDirectory(directoryName) {
  const directoryPath = path.join(__dirname, directoryName);
  const buildOrderFiles = fs.readdirSync(directoryPath);

  /** @type {import('../../utils/common/globalTypes').RaceBuildOrders} */
  const buildOrders = {};
