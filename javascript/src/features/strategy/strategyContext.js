class StrategyContext {
  ...
  /** @type {import("../../utils/core/globalTypes").BuildOrder | import("./strategyManager").Strategy | null | undefined} */
  ...
  /**
   * @param {import("../../utils/core/globalTypes").BuildOrder | import("./strategyManager").Strategy | undefined} strategy
   */
