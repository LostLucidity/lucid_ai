...
class UpgradeActionStrategy extends ActionStrategy {
   ...
   * @param {import("../../types/strategyTypes").PlanStep} planStep Details of the plan step to execute.
   ...
   * @param {import("../../types/strategyTypes").PlanStep} planStep Details of the plan step.
   * @returns {Array<SC2APIProtocol.ActionRawUnitCommand>} Array of actions to be performed.
   */
