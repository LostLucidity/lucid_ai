...
const { getClosestBuilderCandidate, getBuilderCandidateClusters, calculateMovingOrConstructingNonDronesTimeToPosition } = require("../features/pathfinding/pathfinding");
...
const { gatherCandidateWorkersTimeToPosition } = require("../utils/workerManagementUtils");
...
function getBuilder(world, position) {
  ...
  let builderCandidates = getAvailableBuilders(units);
