...
const { flyingTypesMapping, canUnitBuildAddOn, unitTypeTrainingAbilities } = require('./unitConfig');
...
const { getTimeInSeconds, getPathablePositionsForStructure, getDistanceByPath, createUnitCommand } = require('./utils');
const config = require('../config/config');
const { getBuildTimeLeft, getClosestPathWithGasGeysers, getPendingOrders } = require('./sharedUtils');
...
const { handleRallyBase } = require('./workerUtils');
const { handleNonRallyBase } = require('./unitManagement');
...
class BuildingPlacement {
   ...
   */
  static getStructureCells(position, structures) {
