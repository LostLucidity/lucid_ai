 ...
 * @typedef {import('../utils/globalTypes').BuildOrderStep | import('../features/strategy/strategyManager').StrategyStep} GeneralStep
 */
 ...
 * @returns {import('../utils/globalTypes').InterpretedAction[]} - The interpreted actions.
 */
