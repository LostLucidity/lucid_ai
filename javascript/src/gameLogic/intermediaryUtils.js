 ...
 * @typedef {import('../utils/common/globalTypes').BuildOrderStep | import('../features/strategy/strategyManager').StrategyStep} GeneralStep
 */
 ...
 * @param {import('../utils/common/globalTypes').BuildOrder} buildOrder - The build order containing the steps.
 ...
 * @returns {import('../utils/common/globalTypes').InterpretedAction[]} - The interpreted actions.
 */
