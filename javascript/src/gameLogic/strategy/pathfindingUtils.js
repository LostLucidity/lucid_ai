...
const { getStructureCells, getPathablePositions, checkIfPositionIsCorner, getPathCoordinates, getMapPath, getDistanceByPath, getClosestPosition } = require("../../utils/spatial/pathfindingCommon");
