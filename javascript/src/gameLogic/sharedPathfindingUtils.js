...
const { getStructureCells, getPathablePositions, checkIfPositionIsCorner, getPathCoordinates, getMapPath, getClosestPosition, getDistanceByPath } = require("../utils/pathfinding/pathfindingCommon");
