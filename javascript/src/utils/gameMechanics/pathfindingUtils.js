...
const { getStructureCells, getPathablePositions, checkIfPositionIsCorner, getPathCoordinates, getMapPath, getDistanceByPath, getClosestPosition } = require("../spatial/pathfindingCommon");
