...
const { getNeediestMineralField } = require("../../gameLogic/resources/resourceUtils");
...
const { unitTypeTrainingAbilities, flyingTypesMapping } = require("../unitManagement/unitConfig");
