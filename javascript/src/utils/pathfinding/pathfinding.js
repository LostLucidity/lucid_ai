...
const { getPathCoordinates, getClosestPosition, getStructureCells, getPathablePositions, getDistanceByPath } = require("./pathfindingCommon");
...
const { getPathablePositionsForStructure } = require("../common/utils");
