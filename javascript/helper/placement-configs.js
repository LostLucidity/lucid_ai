...
const placementConfigs = {
  ...
  BUNKER: { toBuild: BUNKER, placement: BUNKER, countTypes: [ BUNKER ] },
  ...
  FACTORY: { toBuild: FACTORY, placement: FACTORYTECHLAB, countTypes: [ FACTORY, FACTORYFLYING ] },
  ...
  ROACHWARREN: { toBuild: ROACHWARREN, placement: ROACHWARREN, countTypes: [ ROACHWARREN ] },
  ...
  SPORECRAWLER: { toBuild: SPORECRAWLER, placement: SPORECRAWLER, countTypes: [ SPORECRAWLER ] },
  STARPORT: { toBuild: STARPORT, placement: STARPORTREACTOR, countTypes: [ STARPORT, STARPORTFLYING ] },
  STARGATE: { toBuild: STARGATE, placement: STARGATE, countTypes: [ STARGATE ] },
  SUPPLYDEPOT: { toBuild: SUPPLYDEPOT, placement: SUPPLYDEPOT, countTypes: [ SUPPLYDEPOT, SUPPLYDEPOTLOWERED ] },
