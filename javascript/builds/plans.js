...
const plans = {
  1: {
    ...
    //     mainCombatTypes: [MARINE, MARAUDER, SIEGETANK, SIEGETANKSIEGED, VIKINGFIGHTER ],
    //     supportUnitTypes: [ CYCLONE, LIBERATOR, MEDIVAC ],
    //   },
    //   orders: [
    //     [14, 'build', SUPPLYDEPOT, 0],
    //     [16, 'build', BARRACKS, 0],
    //     [16, 'build', REFINERY, 0],
    //     [[...range(18, 21)], 'scout', SCV, 'EnemyMain', { scoutType: 'earlyScout' }],
    ...
    //     [[...range(52, 55)], 'scout', MARINE, 'OutInFront',],
    //     [[...range(52, 55)], 'scout', MARINE, 'AcrossTheMap',],
    //     [58, 'build', BARRACKS, 1],
    //     [58, 'build', BARRACKS, 2],
    //     [62, 'build', REACTOR, 1],
  ...
  2: {
    lingRoachHydra: {
      ...
      orders: [
        ...
        [38, 'train', OVERLORD, 5],
        [40, 'build', SPORECRAWLER, 0, 'MineralLines', { races: [Race.TERRAN, Race.PROTOSS] }],
        [39, 'build', SPORECRAWLER, 1, 'MineralLines', { races: [Race.TERRAN, Race.PROTOSS] }],
