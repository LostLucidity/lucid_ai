...
const { premoveBuilderToPosition, assignAndSendWorkerToBuild, train, setAndLogExecutedSteps, setFoodUsed, buildSupplyOrTrain, build, addEarmark } = require("../../services/world-service");
const { isTrainingUnit, hasEarmarks } = require("../../services/data-service");
