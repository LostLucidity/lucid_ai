...
const { getTimeInSeconds } = require('../../src/features/shared/pathfinding/pathfinding');
 ...
 * @returns {import('src/core/common').UnitTypeMap}
 */
function buildUnitTypeMap(dataStorage) {
  /** @type {import('src/core/common').UnitTypeMap} */
  const map = {};
