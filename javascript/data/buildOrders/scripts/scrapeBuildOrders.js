 ...
 * @returns {import('src/core/globalTypes').BuildOrderStep[]} An array of build order steps.
 */
function extractSteps(data) {
  const $ = cheerio.load(data);

  /** @type {import('src/core/globalTypes').BuildOrderStep[]} */
  const steps = [];
 ...
 * @returns {Promise<import('src/core/globalTypes').BuildOrderStep[]>} A promise that resolves to an array of build order steps.
 */
